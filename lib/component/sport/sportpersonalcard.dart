                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(person.isBlueTeam ? '청팀' : '홍팀', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600),),
                                ),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: Icon(Icons.accessibility, size: 25.0),
                                ),
                              ),
                          ...
                          SizedBox(
                              ...
                              child: Divider(color: Colors.grey[300], height: 0.05)),
                          const SizedBox(height: 20.0),
                        ],
                      ),
                    ));
