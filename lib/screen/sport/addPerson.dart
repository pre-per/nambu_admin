            ...
            onTap: () {
              if (_formKey.currentState!.validate()) {
                ...
                ScaffoldMessenger.of(context)
                    .showSnackBar(SnackBar(content: Text('인원이 추가되었습니다!'),
                  behavior: SnackBarBehavior.floating,));
                Navigator.of(context).pop();
                provider.clearController();
              } else {
                ScaffoldMessenger.of(context)
                    .showSnackBar(SnackBar(content: Text('형식을 다시 확인하세요'),
                  behavior: SnackBarBehavior.floating,));
              }
            },
            ...
            children: [
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    TextFormFieldWidget(textEditingController: provider.nameController,
                        mainText: '이름',
                        hintText: '대표자 성함',
                    ...
                    TextFormFieldWidget(textEditingController: provider.phoneNumController,
                        mainText: '전화번호',
                    ...
                    TextFormFieldWidget(textEditingController: provider.numController,
                        mainText: '고유번호',
                        hintText: '번호를 입력해주세요',
                        validator: (String? value) {
